...
def draw_keypoints(image,                   #-- Input image
                   ...
                   line_color=(200,100,0),    #-- line's color (b,g,r)
...
if __name__=="__main__":
    ...
    if SOURCE == 'video':
        ...
        while(True):
            ...
            #-- Detect keypoints
            keypoints, _, blob_center = blob_detect(frame, red_min, red_max, blur=3, 
        ...
        image_list = []
        image_list.append(cv2.imread(r"./vision/include/demo2.png"))
        #image_list.append(cv2.imread("blob2.jpg"))
        #image_list.append(cv2.imread("blob3.jpg"))

        for image in image_list:
            #-- Detect keypoints
            keypoints, _ , blob_center= blob_detect(image, red_min, red_max, blur=5, 
