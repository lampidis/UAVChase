...
class BlobDetector:
    ...
    def __init__(self, thr_min, thr_max, blur=15, blob_params=None, detection_window=None):
        ...
        self.image_sub = rospy.Subscriber("/neo11/vi_sensor/camera_depth/camera/image_raw",Image,self.callback)
        print ("<< Subscribed to topic /neo11/vi_sensor/camera_depth/camera/image_raw")
